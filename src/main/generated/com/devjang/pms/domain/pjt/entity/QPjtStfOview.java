...
public class QPjtStfOview extends EntityPathBase<PjtStfOview> {
    ...
    private static final long serialVersionUID = 1084680398L;
    ...
    public final com.devjang.pms.domain.usr.entity.QUsr usr;
    ...
    public QPjtStfOview(Class<? extends PjtStfOview> type, PathMetadata metadata, PathInits inits) {
        ...
        this.usr = inits.isInitialized("usr") ? new com.devjang.pms.domain.usr.entity.QUsr(forProperty("usr")) : null;
    }
