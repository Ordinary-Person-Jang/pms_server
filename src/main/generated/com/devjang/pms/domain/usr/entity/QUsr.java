package com.devjang.pms.domain.usr.entity;
...
public class QUsr extends EntityPathBase<Usr> {
    ...
    private static final long serialVersionUID = -2118100225L;

    public static final QUsr usr = new QUsr("usr");

    public final com.devjang.pms.domain.common.entity.QBaseEntity _super = new com.devjang.pms.domain.common.entity.QBaseEntity(this);
    ...
    public final ListPath<com.devjang.pms.domain.pjt.entity.PjtStfOview, com.devjang.pms.domain.pjt.entity.QPjtStfOview> stfOviews = this.<com.devjang.pms.domain.pjt.entity.PjtStfOview, com.devjang.pms.domain.pjt.entity.QPjtStfOview>createList("stfOviews", com.devjang.pms.domain.pjt.entity.PjtStfOview.class, com.devjang.pms.domain.pjt.entity.QPjtStfOview.class, PathInits.DIRECT2);
