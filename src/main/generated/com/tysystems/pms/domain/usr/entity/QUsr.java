...
public class QUsr extends EntityPathBase<Usr> {
    ...
    private static final long serialVersionUID = -1739114247L;

    public static final QUsr usr = new QUsr("usr");

    public final com.tysystems.pms.domain.common.entity.QBaseEntity _super = new com.tysystems.pms.domain.common.entity.QBaseEntity(this);
    ...
    public final ListPath<com.tysystems.pms.domain.pjt.entity.PjtStfOview, com.tysystems.pms.domain.pjt.entity.QPjtStfOview> stfOviews = this.<com.tysystems.pms.domain.pjt.entity.PjtStfOview, com.tysystems.pms.domain.pjt.entity.QPjtStfOview>createList("stfOviews", com.tysystems.pms.domain.pjt.entity.PjtStfOview.class, com.tysystems.pms.domain.pjt.entity.QPjtStfOview.class, PathInits.DIRECT2);
