...
public class QPjtStfOview extends EntityPathBase<PjtStfOview> {
    ...
    private static final long serialVersionUID = 1071983816L;
    ...
    public final com.tysystems.pms.domain.usr.entity.QUsr usr;
    ...
    public QPjtStfOview(Class<? extends PjtStfOview> type, PathMetadata metadata, PathInits inits) {
        ...
        this.usr = inits.isInitialized("usr") ? new com.tysystems.pms.domain.usr.entity.QUsr(forProperty("usr")) : null;
    }
